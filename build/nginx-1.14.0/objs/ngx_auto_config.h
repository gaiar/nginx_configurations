#define NGX_CONFIGURE " --prefix=/etc/nginx --with-cc-opt='-O3 -fPIE -fstack-protector-strong -Wformat -Werror=format-security -march=native -mtune=native' --with-ld-opt='-Wl,-Bsymbolic-functions -Wl,-z,relro' --sbin-path=/usr/sbin/nginx --conf-path=/etc/nginx/nginx.conf --pid-path=/var/run/nginx.pid --error-log-path=/var/log/nginx/error.log --http-log-path=/var/log/nginx/access.log --http-client-body-temp-path=/var/cache/nginx/client_temp --http-proxy-temp-path=/var/cache/nginx/proxy_temp --http-fastcgi-temp-path=/var/cache/nginx/fastcgi_temp --http-uwsgi-temp-path=/var/cache/nginx/uwsgi_temp --http-scgi-temp-path=/var/cache/nginx/scgi_temp --user=www-data --group=www-data --sbin-path=/usr/sbin/nginx --pid-path=/var/run/nginx.pid --with-pcre=/home/pi/developer/nginx_configurations/build/pcre-8.40 --with-pcre-jit --with-pcre-opt='-march=native -mtune=native' --with-openssl-opt='no-weak-ssl-ciphers no-ssl3 no-shared -DOPENSSL_NO_HEARTBEATS -fstack-protector-strong -march=native -mtune=native' --with-openssl=/home/pi/developer/nginx_configurations/build/openssl-1.1.1-pre6 --with-zlib=/home/pi/developer/nginx_configurations/build/zlib-1.2.11 --with-zlib-opt='-march=native -mtune=native' --with-http_auth_request_module --with-http_gunzip_module --with-http_gzip_static_module --with-http_mp4_module --with-http_realip_module --with-http_ssl_module --with-http_v2_module --with-file-aio --with-ipv6 --with-http_gzip_static_module --with-http_stub_status_module --with-http_geoip_module --with-http_dav_module --with-threads --without-mail_pop3_module --without-mail_smtp_module --without-mail_imap_module --add-module=/home/pi/developer/nginx_configurations/build/nginx-1.14.0/nginx-dav-ext-module-master --add-module=/home/pi/developer/nginx_configurations/build/nginx-1.14.0/nginx-rtmp-module-master"
